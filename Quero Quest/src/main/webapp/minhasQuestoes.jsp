        	...
        	try{
        		...
        		for(int i=0; i<array.length; i++){
        			...
        			try{
                		...
                		ResultSet rs1 = stt1.executeQuery("select tipo, enunciado, altA, altB, altC, altD, altE from questao where idUser like '"
                		+db.getIdUser(session.getAttribute("usuario").toString())+ "' and areaQuestao like '" + array[i] + "' order by rand();");
                		...
                		while(rs1.next()){
                			...
                			String[] array1 = {tipo, enunciado, A, B, C, D, E};
