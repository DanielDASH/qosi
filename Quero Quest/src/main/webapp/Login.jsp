...
<body style="background-image: url(img/backgroundQQ.png); background-size:1140px; background-repeat:no-repeat">
	...
	<div align="center" id="loginlog">
        ...
        <div align="center" style="padding:30px; width: 300px; border-radius:10px" >
            ...
            <h2 style="color:rgba(5,124,196,255)">Login</h2>
            
            <form action="login" id=login >
                <table>
                    <tr>
                        <td colspan="2">
                            <input type="text" name="user" placeholder="email" size="20px" style="border:none; background-color:rgba(45, 45, 48, 0.151); height:20px; border-radius: 5px" required> 
                        </td>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="password" name="pass" placeholder="senha" size="20px" style="border:none; background-color:rgba(45, 45, 48, 0.151); height:20px; border-radius: 5px" required>
                        </td>
                        <td></td>
                    </tr>
                    <tr align="center">
